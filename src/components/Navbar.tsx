  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'glass-nav py-3' : 'bg-transparent py-6'}`}>
      <div className="container mx-auto px-6 flex items-center justify-between">
        <Link href="https://sunilkunchoor.github.io/" className="flex items-center space-x-2 group">
        ...
        <div className="hidden md:flex items-center space-x-6">
          ...
          <div className="flex items-center space-x-4 border-l border-white/10 pl-6 ml-2">
            ...
            <Button asChild variant="outline" className="border-pink-500/50 text-pink-400 hover:bg-pink-500/10 shadow-[0_0_15px_rgba(236,72,153,0.1)] hover:shadow-[0_0_20px_rgba(236,72,153,0.25)] transition-all duration-300 bg-slate-950/30" size="sm">
              <a href="https://sunilkunchoor.github.io/articles/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 font-bold">
          ...
          <div className="flex flex-col p-6 space-y-4">
            ...
            <div className="pt-4 border-t border-white/10 flex flex-col space-y-4">
              <Button asChild variant="outline" className="border-pink-500/50 text-pink-400 hover:bg-pink-500/10 w-full" onClick={() => setIsMobileMenuOpen(false)}>
                <a href="https://sunilkunchoor.github.io/articles/" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-1.5 font-bold">
                  <span className="relative flex h-1.5 w-1.5">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-pink-500 opacity-75"></span>
                    <span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-pink-500"></span>
                  </span>
